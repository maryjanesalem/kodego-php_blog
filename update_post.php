...
<body>
    ...
    <main class="container mx-auto flex py-4 my-4">
        <section class="sm:w-full md:w-2/3 xl:w-3/4">
            ...
            <h2 class="text-2xl font-bold mb-4">Edit This Entry...</h2>
            <div class="-mx-2">
                <div class="w-100 px-2 mb-4">
                    <div class="bg-white rounded p-4 border-2 border-pink-200">

                        <form action="./post_validate.php?method=edit" method="POST">
                            <input type="hidden" name="postID" value="<?php echo $post['id']; ?>">
                            <div class="mb-4">
                                <label for="" class="text-pink-400 font-bold">Title:</label>
                                <input type="text" name="title" class="mt-1 rounded border-2 border-gray-100 outline-1 outline-pink-400 w-full p-2" placeholder="Title of your post" value="<?php echo $post['title']; ?>">
                            </div>
                            <div class="mb-4">
                                <label for="" class="text-pink-400 font-bold">Content:</label>
                                <textarea name="content" id="" cols="30" rows="10" class="mt-1 rounded border-2 border-gray-100 outline-1 outline-pink-400  w-full p-2 max-h-fit" placeholder="Write your content here (preferably in html format...)"><?php echo $post['content']; ?></textarea>
                            </div>
                            <div class="mb-4">
                                <label for="" class="text-pink-400 font-bold">Cover Image URL/Link:</label>
                                <input name="img_link" type="text" class="mt-1 rounded border-2 border-gray-100  outline-1 outline-pink-400 w-full p-2" placeholder="https://" value="<?php echo $post['img_link']; ?>">
                            </div>

                            <button type="submit" class="bg-pink-500 hover:bg-pink-200 px-4 py-2 rounded text-white"><a href="#">Update</a>
                            </button>
                        </form>
